...
const int FONT_HEIGHT_MAIN_TEXT = 75    ; 
...
int main() {
    ...
    string text_to_display = "Escucha con subtítulos en Inglés y Español";
    ...
    string output_filepath = output_dir + "/prueba_output4.png";
